...
(function() {
  ...
  */
  ...
  let bruno = new Person('Bruno', 'Campos', 38);
  let cynthia = new Person('Cynthia', 'Coutinho', 31);
  let marina = new Person('Marina', 'Campos', 0);
  ...
  */
  ...
  console.log(cynthia.getFullName());
  ...
  */
  ...
  console.log(`${cynthia.getFullName()} tem ${cynthia.getAge()} anos.`);
  ...
  */
  ...
  console.log(`${cynthia.getFullName()} agora tem ${cynthia.addAge(2).getAge()} anos.`);
