...
*/
let nordeste = ['Recife', 'Ceará', 'Rio Grande do Norte', 'Paraíba', 'Maranhão']
...
let seteLetras = brasil.every(item => item.length > 7);
...
let haveCeara = brasil.some(item => item === 'Ceará');

console.log(haveCeara
  ? 'Ceará está incluído!'
  : 'Ceará não foi incluído :(');
