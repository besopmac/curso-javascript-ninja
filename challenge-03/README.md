...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é Bruno Campos!"
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // "Olá, eu sou o Bruno Campos, tenho 38 anos, 1.84, meu peso é 99 e, só hoje, eu já caminhei 45 metros !"
```
